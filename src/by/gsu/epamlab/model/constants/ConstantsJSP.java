...
public final class ConstantsJSP {
    ...
    public static final String LOGIN_SUBMIT_NAME = "loginSubmit";

    public static final String REG_LOGIN_NAME = "regLogin";
    public static final String REG_PASSWORD_NAME = "regPassword";
    public static final String REG_CONFIRM_PASSWORD_NAME = "regConfirmPassword";
